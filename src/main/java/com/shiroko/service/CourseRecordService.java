...
public interface CourseRecordService {
    ...
    ResponseDTO<Object> addCourseRecord(InsertCourseRecordDTO insertCourseRecordDTO);

    ResponseDTO<Object> deleteCourseRecord(DeleteCourseRecordDTO deleteCourseRecordDTO);
}
