...
public interface StudentMapper extends BaseMapper<Student> {
     ...
     * @return 学生列表
     */
    IPage<StudentDTO> selectStudentByTeacherId(IPage<StudentDTO> page, @Param("dto") QueryStudentDTO queryStudentDTO);

    IPage<StudentDTO> selectStudentByClassId(IPage<StudentDTO> page, @Param("dto") QueryStudentDTO queryStudentDTO);
